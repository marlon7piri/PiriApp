...
const Footer = () => {
  return (
 <div className='bg-slate-900 text-slate-50 text-center p-4 flex justify-center gap-4'>
  ...
  <a
    ...
    class="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-sky-500 to-black text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
  >
